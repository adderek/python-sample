...
# By default only parts of modules are "exported" - those are defined in __init__.py
...
# If your application is run as the main application (not a module/library) then __name__='__main__'
